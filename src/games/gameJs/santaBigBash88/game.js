...
//        displayManager_.getGroup("freeSpinAccumulatorFs").bg2.children[0].visible=false;
   ...
   function harpPrizeMsgMobile_(par){
    ...
    function doBuyFeature_() {
        ...
        if (displayManager_.getGroup("fsWonPanel").visible==false && bResume_==false && canSpin_==true && spinning_==false && isTumbling_==false && (window.SPIN_STATE==undefined || window.SPIN_STATE.spinning!="true") ) {//todo ask Joe about mobile
