...
// Rectangle
    ...
    function setPortrait_(port){
        ...
        if (port) {
            ...
            setPorytraitAssets_(displayManager_.getGroup("preview").bgPreview1.children[0],true,520,300);
            setPorytraitAssets_(displayManager_.getGroup("preview").bgPreview2.children[0],true,1410 ,300);
    ...
    function initGame_(){
        resume_();
        expandReelSize_(0);
        // todo p3 mainGroupH=displayManager_.getGroup("hReel");
        // groupH= game_.add.group();

        safes[0]=spinManager_.getReels()[0].setIconH(1,13,0);
        safes[1]=spinManager_.getReels()[0].setIconH(2,14,0);
        safes[2]=spinManager_.getReels()[0].setIconH(3,15,0);
        safes[3]=spinManager_.getReels()[0].setIconH(4,16,0);
        conveyorSafes_=[safes[0],safes[1],safes[2],safes[3]];

/*
 'bg-loop_base', timelines: Array(78), duration: 4}
1: Animation {name: 'bg-loop_freegame', timelines: Array(60), duration: 4}
2: Animation {name: 'static_base', timelines: Array(72), duration: 0}
3: Animation {name: 'static_freegame
 */
