function Game(gameRef) {
    ...
    function setPortrait_(port){
        ...
        if (port) {
            if (portraitLoaded_) {
                ...
                xRatio_ = scaleW_ / 900;//ratio between the current Width and the reel width to make the reels bigger as the current width (almost....)
                ...
                if (scaleW_>1000){
                    ...
                    yCompensate=30;
                    xOffset_ = -1 * (ReelConfig.reel.deltaX_0)*xRatio_   +(scaleW_-(820*xRatio_*xCompensate)); //  -1 * (ReelConfig.reel.deltaX_0)+(1280-scaleW_)/2  ; //change the object X position compared to the landcae mode
                    ...
                    if (scaleW_==414 && (scaleH_==622|| scaleH_==620)) {//iphone plus
                        ...
                        xRatio_=xRatio_*.8;
                        xCompensate=1.2;
                        xOffset_ = -1 * (ReelConfig.reel.deltaX_0)*xRatio_   +(scaleW_-(794*xRatio_*xCompensate)); //  -1 * (ReelConfig.reel.deltaX_0)+(1280-scaleW_)/2  ; //change the object X position compared to the landcae mode
                        ...
                        xOffset_ = -1 * (ReelConfig.reel.deltaX_0)*xRatio_   +(scaleW_-(834*xRatio_*xCompensate)); //  -1 * (ReelConfig.reel.deltaX_0)+(1280-scaleW_)/2  ; //change the object X position compared to the landcae mode
                    }
                ...
                adaptPortraitAsset_(displayManager_.getGroup("freeSpinAccumulatorFs"),xOffset_+470*xRatio_,yOffset_+470*xRatio_,xRatio_*1.35);
                adaptPortraitAsset_(displayManager_.getGroup("freeSpins"),xOffset_,yOffset_+40*xRatio_,xRatio_*1.15);
                ...
                adaptPortraitAsset_(displayManager_.getGroup("freeSpinAccumulator"),(buyFeatureEnabled_())?xOffset_+275*xRatio_:xOffset_+335*xRatio_,yOffset_+430*xRatio_,  xRatio_);
                ...
                //top FS
                setPorytraitAssets_(displayManager_.getText("fsmultT"),true,550,592);
                setPorytraitAssets_(displayManager_.getText("fsMultValue"),true,550,627);
            ...
            setPorytraitAssets_(displayManager_.getText("fsMultValue"),true,1152,225);
    ...
    function resume_(){
        ...
        displayManager_.getGroup("freeSpinAccumulator").y = displayManager_.getGroup("freeSpinAccumulator").y - 57;
        //guyin
        if (buyFeatureEnabled_()) {
            ...
            var t = new Phaser.Text(game_,displayManager.groups.buyFeature.buttons.buyFeature.texts.txt.x , displayManager.groups.buyFeature.buttons.buyFeature.texts.txt.y-2,  Translate.do("BUY") + " " +Translate.do("FREE SPINS"), {
