    ...
    function setPortrait_(port){
        ...
        if (port) {
            if (portraitLoaded_) {
                ...
                adaptPortraitAsset_(displayManager_.getGroup("freeSpinAccumulatorFs"),xOffset_+470*xRatio_,yOffset_+400*xRatio_,xRatio_*1.35);
                ...
                displayManager_.getText("winWaysNum").y=160
                for (var i =1;i<5;i++){
            ...
            displayManager_.getText("winWaysNum").y=170;
