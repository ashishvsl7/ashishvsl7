/**
 * KiS Framework, Created by Fabry on 06/09/2021.
 */
function MegaWayTumblingWinSBB(gameRef, gameClass) {
    ...
    function delayedAnimation_(smb,a){
        ...
        if (spinManager_.getAnimationMap(smb.reel[a],smb.icon[a]).animations==null || ReelConfig.keepShowingAnimation==true) //avoid to add the same animation more then once
        {
            ...
            add=true;
            if (smb.smbNum[a]==10){
                if (game.cache.checkImageKey("anim" + smb.smbNum[a]+"_"+spinManager_.getSpinReelResp().reel[smb.reel[a]].smb.length)==true) {
                    smb.anim[a] = game_.add.sprite(smb.pos[a].x + ReelConfig.icon.width / 2,  smb.pos[a].y +  size_[spinManager_.getSpinReelResp().reel[smb.reel[a]].smb.length] / 2, "anim" + smb.smbNum[a]+"_"+spinManager_.getSpinReelResp().reel[smb.reel[a]].smb.length);
                ...
                if (game.cache.checkImageKey("anim" + smb.smbNum[a])==true) {
                    ...
                    if (smb.smbNum[a]==5 ||smb.smbNum[a]==6 ||smb.smbNum[a]==7 ||smb.smbNum[a]==8 ||smb.smbNum[a]==9 ||smb.smbNum[a]==12){
            ...
            if (F!=null && (smb.smbNum[a]!=5 && smb.smbNum[a]!=6)){
                ...
                setTimeout(animateTile_,500,tile, smb.anim[a].smbNum);
            }
            if (smb.smbNum[a]==12) {
                //leaves + 1 animation
                var txt1 = game_.add.sprite(smb.anim[a].x, smb.anim[a].y , "p"+beanVal);

                txt1.alpha=0;
                txt1.anchor.set(.5,.5);
                displayManager_.getGroup("beans").add(txt1);
                ...
                //leave
                soundManager_.playSound("bean");
            }
            if (spinManager_.getSpinReelResp().reel[smb.reel[a]].smb.length>=5 && smb.smbNum[a]!=5 && smb.smbNum[a]!=6 && smb.smbNum[a]!=7 && smb.smbNum[a]!=8 && smb.smbNum[a]!=9  && smb.smbNum[a]!=10 && smb.smbNum[a]!=12 ){
                var ratio=(size_[spinManager_.getSpinReelResp().reel[smb.reel[a]].smb.length]/smb.anim[a].height)+ ((smb.smbNum[a]==10)?.07:.1);
    ...
    function animateTile_ (tile,smbNum){
        if (smbNum!=5 && smbNum!=6) {
            tile.anchor.set(.5, .5);
    ...
    function iconAdjustment_(smbNum,image,icon,frame){
        ...
        if (icon==7){
            var F = game_.add.sprite(frame.x,frame.y, "smbFrame_7_" + smbNum);
        }else{
        ...
        if (icon==5){
            if (smbNum==3) {
                var mask_ = new Phaser.Rectangle(0, 35, frame.width, frame.height-6);
            }else if (smbNum==4) {
                var mask_ = new Phaser.Rectangle(0, 37, frame.width, frame.height-6);
            }else if (smbNum==5) {
                var mask_ = new Phaser.Rectangle(0, 40, frame.width, frame.height-6);
            }else if (smbNum==6) {
                var mask_ = new Phaser.Rectangle(0, 43, frame.width, frame.height-6);
            }else if (smbNum==7) {
                var mask_ = new Phaser.Rectangle(0, 45, frame.width, frame.height-6);
            }
        }else if (icon==6){
            if (smbNum==3) {
                var mask_ = new Phaser.Rectangle(0, 15, frame.width, frame.height-6);
            }else if (smbNum==4) {
                var mask_ = new Phaser.Rectangle(0, 20, frame.width, frame.height-6);
            }else if (smbNum==5) {
                var mask_ = new Phaser.Rectangle(0, 25, frame.width, frame.height-6);
            }else if (smbNum==6) {
                var mask_ = new Phaser.Rectangle(0, 30, frame.width, frame.height-6);
            }else if (smbNum==7) {
                var mask_ = new Phaser.Rectangle(0, 35, frame.width, frame.height-6);
            }
            ...
            if (smbNum==3) {
                var mask_ = new Phaser.Rectangle(0, 88, frame.width, frame.height);
            }else if (smbNum==4) {
                var mask_ = new Phaser.Rectangle(0, 133, frame.width, frame.height);
            }else if (smbNum==5) {
                var mask_ = new Phaser.Rectangle(0, 160, frame.width, frame.height);
            }else if (smbNum==6) {
                var mask_ = new Phaser.Rectangle(0, 180, frame.width, frame.height);
            }else if (smbNum==7) {
                var mask_ = new Phaser.Rectangle(0, 181, frame.width, frame.height);
            }
        }else if (icon==12) {
            if (smbNum==3) {
                var mask_ = new Phaser.Rectangle(0, 45, frame.width, frame.height);
            }else if (smbNum==4) {
                var mask_ = new Phaser.Rectangle(0, 70, frame.width, frame.height);
            }else if (smbNum==5) {
                var mask_ = new Phaser.Rectangle(0, 80, frame.width, frame.height);
            }else if (smbNum==6) {
                var mask_ = new Phaser.Rectangle(0, 93, frame.width, frame.height);
            }else if (smbNum==7) {
    ...
    function changeCentralWinStage_(s){
        ...
        if (s>1){
            for (var i=1;i<s;i++) {
                centralWinMsgGroups_[i].visible=false;
            }
        }
