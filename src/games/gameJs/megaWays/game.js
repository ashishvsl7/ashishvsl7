function Game(gameRef) {
    ...
    function create_() {
        if (framework.isTouch()==true) {
            ...
            if (displayManager_.getGroup("reelsWaves")!=null)displayManager_.getGroup("reelsWaves").visible=true;
        }
        ...
        if (port) {
            if (portraitLoaded_) {
                ...
                if (scaleW_>1000){
                    ...
                    }else if (scaleW_==320 && (scaleH_<455)){
                        xRatio_=xRatio_*.85;
                        xCompensate=1.2;
                ...
                adaptPortraitAsset_(displayManager_.getGroup("reels"),xOffset_,yOffset_-30*xRatio_,xRatio_);
                ...
                adaptPortraitAsset_(displayManager_.getGroup("freeRounds"),xOffset_-130*xRatio_,yOffset_-40*xRatio_,xRatio_*1.15);
                adaptPortraitAsset_(displayManager_.getGroup("bg"),xOffset_,yOffset_-30*xRatio_,xRatio_);
                adaptPortraitAsset_(displayManager_.getGroup("bgFS"),xOffset_,yOffset_-30*xRatio_,xRatio_);
                adaptPortraitAsset_(displayManager_.getGroup("frame"),xOffset_,yOffset_-30*xRatio_,xRatio_);
                adaptPortraitAsset_(displayManager_.getGroup("frameFS"),xOffset_,yOffset_-30*xRatio_,xRatio_);
                adaptPortraitAsset_(displayManager_.getGroup("mask"), xOffset_+(85*xRatio_)/2,-30*xRatio_,xRatio_);
                adaptPortraitAsset_(displayManager_.getGroup("maskFS"), xOffset_-(50*xRatio_),-30*xRatio_,xRatio_);
                adaptPortraitAsset_(displayManager_.getGroup(""),xOffset_,yOffset_,xRatio_);
                adaptPortraitAsset_(displayManager_.getGroup("lockReels"),xOffset_,yOffset_-30*xRatio_,xRatio_);
                adaptPortraitAsset_(displayManager_.getGroup("freeSpinAccumulator"),buyFeatureEnabled_()?xOffset_+190*xRatio_:xOffset_+335*xRatio_,-120*xRatio_,  xRatio_);
                adaptPortraitAsset_(displayManager_.getGroup("buyFeature"), 700*xRatio_ *xCompensate,55*xRatio_,xRatio_*1.18);//-1*( displayManager_.getGroup("idleObjects").children[0].x) + scaleW_/2 ,-1*( displayManager_.getGroup("idleObjects").children[0].y)+20,xRatio_);
                ...
                adaptPortraitAsset_(displayManager_.getGroup("winWays"),scaleW_/2* window.devicePixelRatio,5+yCompensate,xRatio_*1.18);
                ...
                setPorytraitAssets_(displayManager_.getGroup("bg").bg.children[1],true,255);
                setPorytraitAssets_(displayManager_.getGroup("bg").bg1.children[0],false);
                setPorytraitAssets_(displayManager_.getGroup("bg").bg1.children[1],true,1530-207);
                //FS
                ...
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").bg1.children[0],false);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").bg1.children[1],true);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").anchor1_In.children[0],null,108,172);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").anchor2_In.children[0],null,209,172);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").anchor3_In.children[0],null,314,172);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").anchor4_In.children[0],null,420,172);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").anchor1_Out.children[0],null,108,172);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").anchor2_Out.children[0],null,209,172);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").anchor3_Out.children[0],null,314,172);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").anchor4_Out.children[0],null,420,172);

                setPorytraitAssets_(displayManager_.getGroup("winWays").children[0].children[0],false);
                setPorytraitAssets_(displayManager_.getGroup("winWays").children[0].children[1],true,0,675);
                setPorytraitAssets_(displayManager_.getGroup("winWays").children[1],true,0,730);
                if (framework.isTouch())displayManager_.getText("winWaysNum").fontSize=65;
                setPorytraitAssets_(displayManager_.getGroup("buyFeature").children[0],false,0);
                setPorytraitAssets_(displayManager_.getGroup("buyFeature").children[1],true,0);
                setPorytraitAssets_(displayManager_.getGroup("centralLineWin").children[0],null,0);

                //bottom FS
                setPorytraitAssets_(displayManager_.getText("fsLabel"),true,300,595+yCompensate);
                setPorytraitAssets_(displayManager_.getText("fsValue"),true,300,620+yCompensate);
                setPorytraitAssets_(displayManager_.getText("totWonLabel"),true,800,595+yCompensate);
                setPorytraitAssets_(displayManager_.getText("totWonValue"),true,800,620+yCompensate);
                setPorytraitAssets_(displayManager_.getGroup("freeSpins").boxFS.children[0],true,300,625+yCompensate);
                setPorytraitAssets_(displayManager_.getGroup("freeSpins").boxTW.children[0],true,800,625+yCompensate);

                //top FS
                setPorytraitAssets_(displayManager_.getText("fsmultT"),true,300,-170);
                setPorytraitAssets_(displayManager_.getText("fsAdditionalT"),true,800,-170);
                setPorytraitAssets_(displayManager_.getText("fsAdditional"),true,800,-120);
                setPorytraitAssets_(displayManager_.getText("fsMultValue"),true,300,-120);
                setPorytraitAssets_(displayManager_.getGroup("freeSpins").fsP.children[0],true,550,-50);
                setPorytraitAssets_(displayManager_.getGroup("freeSpins").boxMu.children[0],true,300,-100);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs").bg1.children[0],true,800,-100);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs").bg2.children[0],true,800,-100);

                for (var i =1;i<5;i++){
                    setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["anchor" + i +"_In"].children[0],null, displayManager.groups.freeSpinAccumulatorFs.graphAsset["anchor"+i+"_In"].x-364,displayManager.groups.freeSpinAccumulatorFs.graphAsset["anchor"+i+"_In"].y-330);
                    setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["anchor" + i +"_Out"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["anchor"+i+"_Out"].x-364,displayManager.groups.freeSpinAccumulatorFs.graphAsset["anchor"+i+"_Out"].y-330);
                }
                ...
                displayManager_.getGroup("logo").children[0].visible=false;
            ...
            setPorytraitAssets_(displayManager_.getGroup("bg").bg.children[0],true,256);
            setPorytraitAssets_(displayManager_.getGroup("bg").bg1.children[1],false);
            setPorytraitAssets_(displayManager_.getGroup("bg").bg1.children[0],true,1024+256);
            //fs
            ...
            setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").bg1.children[0],true);
            setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator").bg1.children[1],false);
            ...
            for (var i=1;i<5;i++) {
                ...
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["anchor"+i+"_Out"].children[0], null, displayManager.groups.freeSpinAccumulator.graphAsset["anchor"+i+"_Out"].x,displayManager.groups.freeSpinAccumulator.graphAsset["anchor"+i+"_Out"].y);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["anchor" + i +"_In"].children[0],null, displayManager.groups.freeSpinAccumulatorFs.graphAsset["anchor"+i+"_In"].x,displayManager.groups.freeSpinAccumulatorFs.graphAsset["anchor"+i+"_In"].y);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["anchor" + i +"_Out"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["anchor"+i+"_Out"].x,displayManager.groups.freeSpinAccumulatorFs.graphAsset["anchor"+i+"_Out"].y);
            }

            setPorytraitAssets_(displayManager_.getGroup("winWays").children[0].children[0],true,1162,40);
            setPorytraitAssets_(displayManager_.getGroup("winWays").children[0].children[1],false,1162,40);
            setPorytraitAssets_(displayManager_.getGroup("winWays").children[1],true,1162,76);
            ...
            //top FS
            setPorytraitAssets_(displayManager_.getText("fsmultT"),true,120,167);
            setPorytraitAssets_(displayManager_.getText("fsAdditionalT"),true,1160,167);
            setPorytraitAssets_(displayManager_.getText("fsAdditional"),true,1156,206);
            setPorytraitAssets_(displayManager_.getGroup("freeSpins").fsP.children[0],true,640,0);
            setPorytraitAssets_(displayManager_.getGroup("freeSpins").boxMu.children[0],true,118,226);
            setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs").bg1.children[0],true,1164,226);
            setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs").bg2.children[0],true,1164,226);



            //bottom FS
            setPorytraitAssets_(displayManager_.getText("fsLabel"),true,1160,70);
            setPorytraitAssets_(displayManager_.getText("fsValue"),true,1160,86);
            setPorytraitAssets_(displayManager_.getText("fsMultValue"),true,120,206);
            setPorytraitAssets_(displayManager_.getText("totWonLabel"),true,120,70);
            setPorytraitAssets_(displayManager_.getText("totWonValue"),true,120,86);
            setPorytraitAssets_(displayManager_.getGroup("freeSpins").boxFS.children[0],true,1164,100);
            setPorytraitAssets_(displayManager_.getGroup("freeSpins").boxTW.children[0],true,120,100);
            ...
            displayManager_.getGroup("logo").children[0].visible=true;
        }
    ...
    function resume_(){
        ...
        if (buyFeatureEnabled_()) {
            ...
            if (framework.isTouch()){
                //portrait asset
                buttonBFP_ = new Phaser.Button(game_, displayManager.groups.buyFeature.buttons.buyFeatureP.x, displayManager.groups.buyFeature.buttons.buyFeatureP.y, displayManager.groups.buyFeature.buttons.buyFeatureP.name, me[displayManager.groups.buyFeature.buttons.buyFeatureP.evt], this, 1,2,0,0 );
                buttonBFP_.anchor.set(0.5, 0.5);

                var t = new Phaser.Text(game_,displayManager.groups.buyFeature.buttons.buyFeatureP.texts.txt.x , displayManager.groups.buyFeature.buttons.buyFeatureP.texts.txt.y,  Translate.do(displayManager.groups.buyFeature.buttons.buyFeatureP.texts.txt.text), {
                    font: displayManager.groups.buyFeature.buttons.buyFeatureP.texts.txt.font,
                    fill: displayManager.groups.buyFeature.buttons.buyFeatureP.texts.txt.fill,
                    align: displayManager.groups.buyFeature.buttons.buyFeatureP.texts.txt.align
                });
                t.stroke = displayManager.groups.buyFeature.buttons.buyFeatureP.texts.txt.stroke;
                t.strokeThickness = displayManager.groups.buyFeature.buttons.buyFeatureP.texts.txt.stroke_tick;
                t.anchor.set(0.5, .5);
                buttonBFP_.addChild(t);

                displayManager_.getGroup("buyFeature").add(buttonBFP_);
    ...
    function startWaveGenerator_(){
        if (framework.isTouch()==true)return;
        if (freeSpinsManager_.getIsInFs()==false)TweenMax.to(displayManager_.getGroup("reelsWaves")["waves"].children[0],Util.getRandomInt(90,120)/100,{delay: Util.getRandomInt(20,60)/100,y:Util.getRandomInt(1093,1097),onComplete:wavesBack_, ease:Power0.easeInOut});
        //setTimeout(startWaveGenerator_,Util.getRandomInt(2500,5000));
    }

    function wavesBack_(){
        if (freeSpinsManager_.getIsInFs()==false)TweenMax.to(displayManager_.getGroup("reelsWaves")["waves"].children[0],1,{y:1102,onComplete:startWaveGenerator_, ease:Power0.easeInOut});
    }
    ...
    function moveLockedReels_(resume){
        ...
        if ((spinManager_.getSpinReelResp()!=null || resume) && buyIn_==false) {
            ...
            if (reelLocked_ != lockedReelPos_) {
                if (reelLocked_ > 0) {
                    for (var i = 0; i < 6; i++) {
                        var skull = (displayManager_.getGroup("lockReels")["lockSkull_" + i]!=undefined)?displayManager_.getGroup("lockReels")["lockSkull_" + i].children[0]:null;
                        var bones = displayManager_.getGroup("lockReels")["lockIn_" + i].children[0];

                        if (lockedReelCOnfiguration[i]=="1" && bones.visible == false) {
                            if (skull!=null) {
                                skull.visible = true;
                                skull.animations.add("anim");
                                skull.animations.play("anim", 24, false, false);
                            }
                            bones.visible = true;
            ...
            if (sucessiveWin_>0){
                ...
                for (var i = 1; i < 5; i++) {
                    ...
                    if (anchor.visible == true) {
                        ...
                        anchor.setFrame(0);
                        anchor = displayManager_.getGroup("freeSpinAccumulator"+fs)["anchor" + i + "_Out"].children[0];
                        anchor.visible = true;
                        anchor.animations.add("anim");
                        anchor.animations.play("anim", fps, false, false, fsWinCloverOut_, anchor);
    ...
    function stopSpinMusic_(){
        ...
        if (sucessiveWin_==0){
            ...
            if(soundManager_.getBGSound("bgSlot1")!=undefined)soundManager_.getBGSound("bgSlot1").fadeOutBgSound(1000);
        }
        quiteSpinMusic=0;
    ...
    function decreaseVolumeBG_(fadeT_O_){
        ...
        if (lastSound_>0) {
            for (var a = 1; a <= lastSound_; a++) {
                if(soundManager_.getBGSound("bgSlot" + a)!=undefined)soundManager_.getBGSound("bgSlot" + a).fadeOutBgSoundExternal(500, (freeSpinsManager_.getIsInFs()?.3:.5));
            }
        }
        if (fadeT_O_!=null){
            fadeBg_=false;
    ...
    function increaseVolumeBG_(force){
        ...
        if (fadeBg_ || force) {
            fadeBg_=false;
            soundManager_.getBGSound("bgSlot").fadeInBgSoundExternalJustVol(1000, .8);
            if (lastSound_>0) {
                for (var a = 1; a <= lastSound_; a++) {
...
return;
    ...
    function enableButton_() {
        ...
        freeRoundsManager_.updateFreeRoundsTot();
//alert(winManager_.getWinAmt()+ " "+lineManager_.getTotalTumblingWin() )
    ...
    function wavesDown_(){
        //just on desktop
        TweenMax.to(displayManager_.getGroup("reelsWaves").wavesFS.children[0],1,{alpha:0});
        if (!mustConfirmFS_()) {
            var waves = displayManager_.getGroup("fsWonPanel");
            TweenMax.to(waves, 1, {delay: .5, alpha: 0});
        }
    }

    function animateFS_() {
        if(displayManager_.getGroup("reelsWaves")!=null) {
            //just on desktop
            displayManager_.getGroup("reelsWaves").waves.children[0].visible = false;
            displayManager_.getGroup("reelsWaves").wavesFS.children[0].visible = true;
            displayManager_.getGroup("reelsWaves").wavesFS.children[0].alpha = 1;
            displayManager_.getGroup("reelsWaves").wavesFS.children[0].y = displayManager_.getGroup("reelsWaves").waves.children[0].y;
            TweenMax.to(displayManager_.getGroup("reelsWaves").wavesFS.children[0], 1, {y: 200});
            displayManager_.getGroup("idleObjects").visible = false;
            displayManager_.getGroup("logo").visible = false;
            displayManager_.getGroup("bg").visible = false;
            displayManager_.getGroup("mask").visible = false;
            ...
            if (buttonBF_!=undefined)buttonBF_.visible = false;
            moveAnchor_();
        }
    }
    ...
    function logoIn_(){
        if (framework.isTouch()) {
            ...
            displayManager_.getGroup("winWays").y=0;
            displayManager_.getGroup("reelsWaves").wavesFS.children[0].y=1102;
            displayManager_.getGroup("reelsWaves").waves.children[0].y=1102;
            displayManager_.getGroup("reelsWaves").wavesFS.children[0].alpha=1;
            displayManager_.getGroup("reelsWaves").waves.children[0].visible=true;
            displayManager_.getGroup("reelsWaves").wavesFS.children[0].visible=false;
        }
        displayManager_.getGroup("buyFeature").visible=true;
        displayManager_.getGroup("lockReels").visible = false;
    ...
    function fsHideTotPanel_(){
        ...
        if(displayManager_.getGroup("idleObjects")!=undefined)displayManager_.getGroup("idleObjects").visible = true;
        lastSound_=1;
    }
    ...
    function setSpin_(par){
        if (freeSpinsManager_.getIsInFs()) {
            ...
            lineManager_.clearLineAfterValue();
            for (var i = 2; i < 4; i++) {
                if (soundManager_.getBGSound("bgSlot" + i)){
                    soundManager_.playAdditionalBgSound_("bgSlot" + i);
                    soundManager_.getBGSound("bgSlot" + i).fadeInBgSoundExternal(500, 1, soundManager_.getBGSound("bgSlot").getSound().currentTime, null);
                }
            }
            lastSound_ = 3;
            stopRandomMessages_();
