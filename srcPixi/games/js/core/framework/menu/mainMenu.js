    ...
    this.showReplay = function(json) {
        ...
        $.each(spin.reel, function(columnIndex, column) {
            ...
            for (var i = 0; i <numSmb; i++) {
                ...
                if ((gameParams.gameOriginalID === '7016' ||gameParams.gameOriginalID === '7034' || gameParams.gameOriginalID === '7019' || gameParams.gameOriginalID === '7029' || isBrandedMw() || gameParams.gameOriginalID === '7033'  || gameParams.gameOriginalID === '7027' || gameParams.gameOriginalID === '7031' || gameParams.gameOriginalID === '7127' || gameParams.gameOriginalID === '7227' ) && column.smb[i]==undefined ){
            ...
            //Else not on blood queen or no expanding wild
                ...
                for (var i = 0; i <numSmb; i++) {//
                    ...
                    reel += '<div class="' + cl + '">';
                    if (gameParams.gameOriginalID === '7016' ||gameParams.gameOriginalID === '7034' || gameParams.gameOriginalID === '7019' || gameParams.gameOriginalID === '7029' || isBrandedMw() || gameParams.gameOriginalID === '7033' || gameParams.gameOriginalID === '7027' || gameParams.gameOriginalID === '7127' || gameParams.gameOriginalID === '7227' || gameParams.gameOriginalID === '7031') {
                        reel += "<img src=\"" + gameAssets.assets["iconGH" + getSymbolPMW(grid[columnIndex][i], this_.displayBet, column.smb[i])] + "\" alt=\"Spin Icon " + grid[columnIndex][i] + "\" class=\"" + getSymbolClass(grid[columnIndex][i], columnIndex, i) + "\" />";
                    }else if (gameParams.gameOriginalID === '7018' ){
                        reel += "<img src=\"" + gameAssets.assets["iconGH" + getSymbolBook(grid[columnIndex][i], this_.displayBet, column.smb[i])] + "\" alt=\"Spin Icon " + grid[columnIndex][i] + "\" class=\"" + getSymbolClass(grid[columnIndex][i], columnIndex, i) + "\" />";

                    }else {
                        reel += "<img src=\"" + gameAssets.assets["iconGH" + getSymbol(grid[columnIndex][i], this_.displayBet, column.smb[i])] + "\" alt=\"Spin Icon " + grid[columnIndex][i] + "\" class=\"" + getSymbolClass(grid[columnIndex][i], columnIndex, i) + "\" />";
                    }
        ...
        if (ReelConfig.winningcombinations) {
            ...
            //Else if no paylines
            if (lineConfig.line.lines.length === 0 && (gameParams.gameOriginalID != '7027' &&gameParams.gameOriginalID != '7127' &&gameParams.gameOriginalID != '7227' && gameParams.gameOriginalID != '7033' && gameParams.gameOriginalID != '7024'  && gameParams.gameOriginalID != '7034' && gameParams.gameOriginalID != '7031' && gameParams.gameOriginalID != '7029')) {
                ...
                if (gameParams.gameOriginalID === '7012') {
                    ...
                    for (var i in spin.matches) {
                        ...
                        for (var j = 0; j < match.coord.length; j++) {
                            ...
                            html += '<img class="won" src="' + gameAssets.assets["iconGH" + smb] + '" alt="Spin Icon ' + smb + '" />';
                ...
                if (gameParams.gameOriginalID === '7027' || gameParams.gameOriginalID === '7127' || gameParams.gameOriginalID === '7227') {
                    ...
                    for (var i in lines) {
                        ...
                        for (var j = 0; j < line.count; j++) {
                                lineHTML += '<img class="won" src="' + gameAssets.assets["iconGH" + getSymbolPMW(smb)] + '" alt="Spin Icon ' + smb + '" />';
                        }
                    ...
                    for (var i in lines) {
                        ...
                        var smb = spin.reel[0].smb[Number(line.id) - 1].smb;
                        for (var j = 0; j < line.count; j++) {
                            if (gameParams.gameOriginalID === '7016' || gameParams.gameOriginalID === '7034' || gameParams.gameOriginalID === '7019' || gameParams.gameOriginalID === '7029' || isBrandedMw() || gameParams.gameOriginalID === '7033') {
                                lineHTML += '<img class="won" src="' + gameAssets.assets["iconGH" + getSymbolPMW(smb)] + '" alt="Spin Icon ' + smb + '" />';
                            }else{
                                lineHTML += '<img class="won" src="' + gameAssets.assets["iconGH" + smb] + '" alt="Spin Icon ' + smb + '" />';
                            }
                        }
        ...
        //Standard set paylines
            ...
            $.each(framework.getSetup().getPaylines(), function(lineIndex, line) {
                ...
                if ((Number(gameParams.gameOriginalID) >= '7016' || Number(gameParams.gameOriginalID) >= '7034' )&& getOrientation()=="portrait") {
                ...
                $.each(line.payline, function(column, symbol) {
                    if (gameParams.gameOriginalID != '7015')
                    {
                        ...
                        if (gameParams.gameOriginalID === '7016' || gameParams.gameOriginalID === '7034' || gameParams.gameOriginalID === '7019' || gameParams.gameOriginalID === '7029' || isBrandedMw() || gameParams.gameOriginalID === '7033'|| gameParams.gameOriginalID === '7027'|| gameParams.gameOriginalID === '7031') {
                            lineHTML += "src=\"" + gameAssets.assets["iconGH" + getSymbolPMW(grid[column][symbol], this_.displayBet, spin.reel[column].smb[symbol])] + "\" ";
                        }else if (gameParams.gameOriginalID === '7018'){
                            lineHTML += "src=\"" + gameAssets.assets["iconGH" + getSymbolBook(grid[column][symbol], this_.displayBet, spin.reel[column].smb[symbol])] + "\" ";
                        }else{
                            lineHTML += "src=\"" + gameAssets.assets["iconGH" + getSymbol(grid[column][symbol], this_.displayBet, spin.reel[column].smb[symbol])] + "\" ";
                        }
                        ...
                        //Add symbol image to current line HTML
                        lineHTML += "<img ";
                        lineHTML += "src=\"" + gameAssets.assets["iconGH" + getSymbolRichie(grid[column][symbol], this_.displayBet, spin.reel[column].smb[symbol])] + "\" ";
                        lineHTML += "alt=\"Spin Icon " + grid[column][symbol] + "\" ";
                        lineHTML += "class=\"";
                        lineHTML += (spin.line[line.id] && count++ < spin.line[line.id].count ? "won " : "");
                        lineHTML += getSymbolClass(grid[column][symbol], column, symbol) + " ";
        ...
        if (gameParams.gameOriginalID === '7004') {
            ...
            if (spin.egg >= 0 && spin.egg <= 4) {
                ...
                egg.symbol = gameAssets.assets["iconGH" + spin.egg];
            ...
            var scattersList = "<ul>";
            scattersList += "<li>";
            scattersList += "<img src=\"" + gameAssets.assets["iconGH12"] + "\" alt=\"Spin Icon 12" + "\" />";
            scattersList += "<p>";
        ...
        //If there were any scatters
            ...
            $.each(spin.scatter, function(scatterSymbol, details) {
                ...
                if (gameParams.gameOriginalID === '7015') {
                    scattersList += "<li>";
                    scattersList += "<img src=\"" + gameAssets.assets["iconGH" + scatterSymbol] + "\" alt=\"Spin Icon " + scatterSymbol + "\" />";
                    scattersList += "<p>";
                    ...
                    scattersList += "<br>";
                    scattersList += "<img src=\"" + gameAssets.assets["iconGH12"] + "\" alt=\"Spin Icon " + scatterSymbol + "\" />";
                    scattersList += "<p>";
                ...
                }else if (gameParams.gameOriginalID === '7031' || gameParams.gameOriginalID === '7128' || gameParams.gameOriginalID === '7228') {//RR
                    scattersList += "<li>";
                    scattersList += "<img src=\"" +gameAssets.assets["iconGH12"] + "\" alt=\"Spin Icon " + scatterSymbol + "\" />";
                    scattersList += "<p>";
            ...
            scattersList += "</ul>";
            if ( gameParams.gameOriginalID != '7019' && gameParams.gameOriginalID != '7029' && gameParams.gameOriginalID != '7031') {
                //If "NEW_UI"
                if (ReelConfig.newUI) {
                ...
                scatterReel += ">";
                if (gameParams.gameOriginalID != '7015' && gameParams.gameOriginalID != '7024' && gameParams.gameOriginalID != '7027' && gameParams.gameOriginalID != '7031') {
                    //Loop through each column in spin reel
                    $.each(spin.reel, function (columnIndex, column) {
                        ...
                        for (var i = 0; i < ReelConfig.numIcons; i++) {
                            if(grid[columnIndex][i]!=undefined) {
                                ...
                                scatterReel += ";\"";
                                scatterReel += " src=\"" + gameAssets.assets["iconGH" + getSymbol(grid[columnIndex][i], this_.displayBet, column.smb[i])] + "\"";
        ...
        if (
            ...
            json.bonus ||
            ((gameParams.gameOriginalID === '7016' ||gameParams.gameOriginalID === '7034' || gameParams.gameOriginalID === '7019' || gameParams.gameOriginalID === '7029' || isBrandedMw() || gameParams.gameOriginalID === '7033' || gameParams.gameOriginalID === '7008' || gameParams.gameOriginalID === '7017' || gameParams.gameOriginalID === '7014' || gameParams.gameOriginalID === '7012') && (spin.bonus || spin.multiplier)) ||
