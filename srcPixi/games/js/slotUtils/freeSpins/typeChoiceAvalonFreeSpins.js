/**
 * KiS Framework, Created by Fabry on 06/11/2019.
 * Avalon FS class, choice between different type of FS (based on BQ)
 * version 1.0.0
 */
function TypeChoiceAvalonFreeSpins(gameRef,gameClass){
    var game_=gameRef;
    ...
    function parse_(json){
        ...
        if (json.freeSpin!=null){
            ...
            type_=json.freeSpin.type; //FS type, depend on the choice
            ...
            type_=json.status.type; //FS type, depend on the choice
        }
    ...
    function logoOutcomplete_(){
        ...
        displayManager_.getGroup("bgFS"+type_).visible=true;
        displayManager_.getGroup("maskFS"+type_).visible=true;
        displayManager_.getGroup("frameFS"+type_).visible=true;
    ...
    function hideTotPanel_(){
        ...
        displayManager_.getGroup("bgFS0").visible=false;
        displayManager_.getGroup("maskFS0").visible=false;
        displayManager_.getGroup("frameFS0").visible=false;
    ...
    function showFsPanel_(num){
        ...
        displayManager_.getText("fsWLabel1").setText(Translate.do("Free Spins") + "\r" + "\r"+Translate.do("Choose one of them"));
    ...
    debugger;
        ...
        //choice GFX
        displayManager_.getGroup("fsWonPanel").sel1.children[0].visible=false;
        displayManager_.getGroup("fsWonPanel").sel2.children[0].visible=false;
        displayManager_.getGroup("fsWonPanel").sel1_hl.children[0].visible=false;
        displayManager_.getGroup("fsWonPanel").sel2_hl.children[0].visible=false;
    ...
    var me={
        ...
        fsWon:function(num){
            if (!fsWon_) {
                ...
                fsWon_ = false;//comes from the FS choice
            }
        },
        parse:parse_,
        resumeFs:resumeFs_,
