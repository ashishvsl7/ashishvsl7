...
var gameAssets = {
    ...
    "animations": {
        ...
        "lamp": {
            "json": "jekyllHyde/img/bg/street-lamp.json",
            "sprite": "jekyllHyde/img/bg/street-lamp.png"
        }
    },
    "importantSounds": {
        "spinClick": {
    ...
    "sounds": {
        ...
        "wildReelOut": {
            "name": "jekyllHyde/sounds/wildReelRollback.mp3",
            "volume": .4
        },
        "fsWildReelOut": {
    ...
    "bgSounds": {
        "bgSlot": {
            "name": "jekyllHyde/sounds/bg.mp3",
            "volume": .3
        },

        "bgFs": {
            "name": "jekyllHyde/sounds/bgFs.mp3",
            "volume":.35
        }
    }
