...
function MegaWayTumblingWinjack(gameRef, gameClass) {
    ...
    function initClass_() {
        ...
        //central win
        centralWinGroup_=displayManager_.getGroup("centralWin");
        centralWinMsgGroups_[1]=displayManager_.getGroup("centralWin").bigWin;
        centralWinMsgGroups_[2]=displayManager_.getGroup("centralWin").sBigWin;
        centralWinMsgGroups_[3]=displayManager_.getGroup("centralWin").mBigWin;
        centralWinMsgPos_[1]=displayManager_.getGroup("centralWin").bigWin.y;
        centralWinMsgPos_[2]=displayManager_.getGroup("centralWin").sBigWin.y;
        centralWinMsgPos_[3]=displayManager_.getGroup("centralWin").mBigWin.y;
        ...
        //p3 for (var a in displayManager.groups.centralWin.buttons) {
    ...
    //x20, 50x,  x100
    var winAnim = {
        "winClasses_":    [1,   10,  20,  40, 80, 199, 400, 1000, 1500],
    ...
    function removeCW_(a){
        ...
        centralWinGroup_.bgmsg.visible=false;
    }
    ...
    function changeCentralWinStage_(flip){
        ...
        centralWinGroup_.bgmsg.visible=true;
        if (stage_==0) {
            for (var a=1; a<=centralWinMsgGroups_.length-1;a++) {
                centralWinMsgGroups_[a].alpha = 0;
                centralWinMsgGroups_[a].y=-200;
