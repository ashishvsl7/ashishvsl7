/**
 * KiS Framework, Created by Fabry on 10/05/2021
 * handles megaways RR  free spins
 */
function RRMwFreeSpins(gameRef,gameClass){
    var game_=gameRef;
    ...
    function showFsPanel_(){
        ...
        displayManager_.getText("fsWLabel1").setText( (addFs_)?Translate.do("Additional Free Spins"):Translate.do("Free spins"));
    ...
    var me={
        ...
        fsWon:function(num){
            ...
            if (isInFs_==false){
                ...
                addFs_=true;
                freeSpinNum_=num + Number(displayManager_.getText("fsValue").text)
            }
        },
        parse:parse_,
        resumeFs:resumeFs_,
