...
function WildManager(gameRef,gameClass,_ReelConfig) {
    ...
    var me = {
        ...
        hasWildReel:function(){
            if (ReelConfig_.wildType!="WildReel" && ReelConfig_.wildType!="WildShiftingReel" && ReelConfig_.wildType!="ExpandingStickyWild" && ReelConfig_.wildType!="ExpandingStickyWild" && ReelConfig_.wildType!="FightStickyWild" ) {
                return false;
            }else{
