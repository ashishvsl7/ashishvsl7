/**
 * KiS Framework, Created by Fabry on 25/11/2020.
 * handles rainbow megaways free spins
 */
function PixiRainbowMwFreeSpins(gameRef,gameClass){
    var game_=gameRef;
...
//        gameClass_.moveLockedReels(true);
    ...
    function toggleFreeSpins_ () {
        ...
        if (isInFs_ && freeSpinNum_>0) {
            ...
            if (freeRoundsManager_.getIsInFr()==false && gameInfo.freeRoundsAvailable!=true){
                ...
                TweenMax.to(displayManager_.getGroup("freeSpins"),.4,{y:0,alpha:1,ease:Bounce.easeOut});
            }
    ...
    function logoOut_() {
        TweenMax.to(displayManager_.getGroup("freeSpins"), .4, {y: 0,alpha:1, ease: Bounce.easeOut,onComplete:logoOutcomplete_});
    }
    ...
    function showFsPanel_(){
       ...
       if(gameClass_.getBuyIn()==true)winCash_=0;
        ...
        displayManager_.getText("fsValue1").fontSize=144;
        displayManager_.getText("fsValue1").y=200;
        displayManager_.getText("fsWLabel1").fontSize=60;
    ...
    function toggleBackFs_(cap){
        if (gameClass_.getLineCompletion()) {
            ...
            displayManager_.getText("fsValue1").y=270;

            displayManager_.getText("fsWLabel1").fontSize=43;
