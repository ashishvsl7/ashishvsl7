    ...
    function setPortrait_(port){
        ...
        if (port) {
            if (portraitLoaded_) {
                ...
                adaptPortraitAsset_(displayManager_.getGroup("harp"),xOffset_,yOffset_+85*xRatio_,  xRatio_);
                adaptPortraitAsset_(displayManager_.getGroup("buyFeature"), xOffset_-1330*xRatio_,yOffset_-265*xRatio_,xRatio_*1.7);//-1*( displayManager_.getGroup("idleObjects").children[0].x) + scaleW_/2 ,-1*( displayManager_.getGroup("idleObjects").children[0].y)+20,xRatio_);

                if (fs==""){
                    adaptPortraitAsset_(displayManager_.getGroup("centralLineWin"), scaleW_/2* window.devicePixelRatio,yOffset_,xRatio_);
                }else{
                    adaptPortraitAsset_(displayManager_.getGroup("centralLineWin"), scaleW_/2* window.devicePixelRatio,yOffset_+490*xRatio_,xRatio_);
                }
                adaptPortraitAsset_(displayManager_.getGroup("centralWin"), xOffset_,yOffset_ - 50,xRatio_);
                adaptPortraitAsset_(displayManager_.getGroup("winWays"), xOffset_+520*xRatio_,+840*xRatio_,xRatio_);
                ...
                setPorytraitAssets_(displayManager_.getGroup("mask").bg2.children[1],true,-90,(210+560+85));
                setPorytraitAssets_(displayManager_.getGroup("mask").bg3.children[0],false);
                setPorytraitAssets_(displayManager_.getGroup("mask").bg3.children[1],true,-90);
                //fs
                setPorytraitAssets_(displayManager_.getGroup("maskFS").bg2.children[0],false);
                setPorytraitAssets_(displayManager_.getGroup("maskFS").bg2.children[1],true,null,(214+560+85));
                ...
                setPorytraitAssets_(displayManager_.getGroup("bg").bg.children[1],true,1002);
                setPorytraitAssets_(displayManager_.getGroup("bg").bg1.children[0],false);
                setPorytraitAssets_(displayManager_.getGroup("bg").bg1.children[1],true,-50);
                //FS
                setPorytraitAssets_(displayManager_.getGroup("bgFS").bg.children[0],false);
                setPorytraitAssets_(displayManager_.getGroup("bgFS").bg.children[1],true,1002);
                ...
                //harp
                setPorytraitAssets_(displayManager_.getGroup("harp").he.children[0],null,945,250);
                setPorytraitAssets_(displayManager_.getText("harptext"),null,null,150);
                setPorytraitAssets_(displayManager_.getText("harpHead"),null,null,120);
                ...
                //bottom FS
                setPorytraitAssets_(displayManager_.getText("fsLabel"),true,336,-175);
                setPorytraitAssets_(displayManager_.getText("fsValue"),true,336,-150);
                setPorytraitAssets_(displayManager_.getText("totWonLabel"),true,766,-175);
                setPorytraitAssets_(displayManager_.getText("totWonValue"),true,766,-150);

                //top FS
                setPorytraitAssets_(displayManager_.getText("fsmultT"),true,550,-170);
                setPorytraitAssets_(displayManager_.getText("fsAdditionalT"),true,800,-170);
                setPorytraitAssets_(displayManager_.getText("fsAdditional"),true,370,-125);
                setPorytraitAssets_(displayManager_.getText("fsMultValue"),true,550,-145);

                for (var i =8;i<=13;i++){
                    setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos" + i +"_Off"].children[0],null,null, displayManager.groups.freeSpinAccumulator.graphAsset["fsPos" + i +"_Off"].y-70);
                    setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos" + i +"_On"].children[0],null,null, displayManager.groups.freeSpinAccumulator.graphAsset["fsPos" + i +"_On"].y-70);
                    //displayManager_.getGroup("freeSpinAccumulator")["anchor" + i +"_In"].children[0].scale.x=-1;
                }

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos8_Off"].children[0],null, displayManager.groups.freeSpinAccumulator.graphAsset["fsPos8_Off"].x+78);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos8_On"].children[0],null,displayManager.groups.freeSpinAccumulator.graphAsset["fsPos8_On"].x+78);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos9_Off"].children[0],null, displayManager.groups.freeSpinAccumulator.graphAsset["fsPos9_Off"].x+47);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos9_On"].children[0],null,displayManager.groups.freeSpinAccumulator.graphAsset["fsPos9_On"].x+47);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos10_Off"].children[0],null, displayManager.groups.freeSpinAccumulator.graphAsset["fsPos10_Off"].x+15);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos10_On"].children[0],null,displayManager.groups.freeSpinAccumulator.graphAsset["fsPos10_On"].x+15);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos11_Off"].children[0],null, displayManager.groups.freeSpinAccumulator.graphAsset["fsPos11_Off"].x-15);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos11_On"].children[0],null,displayManager.groups.freeSpinAccumulator.graphAsset["fsPos11_On"].x-15);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos12_Off"].children[0],null, displayManager.groups.freeSpinAccumulator.graphAsset["fsPos12_Off"].x-47);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos12_On"].children[0],null,displayManager.groups.freeSpinAccumulator.graphAsset["fsPos12_On"].x-47);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos13_Off"].children[0],null, displayManager.groups.freeSpinAccumulator.graphAsset["fsPos13_Off"].x-78);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos13_On"].children[0],null,displayManager.groups.freeSpinAccumulator.graphAsset["fsPos13_On"].x-78);



                for (var i =1;i<=6;i++){
                    setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos" + i +"_Off"].children[0],null,null, displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos" + i +"_Off"].y-70);
                    setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos" + i +"_On"].children[0],null,null, displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos" + i +"_On"].y-70);
                    if(displayManager_.getGroup("freeSpinAccumulatorFs")["fsAnimation" + i +"_On"]!=undefined)setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsAnimation" + i +"_On"].children[0],null,null, displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsAnimation" + i +"_On"].y-70);
                }

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos1_Off"].children[0],null, displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos1_Off"].x-55);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos1_On"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos1_On"].x-55);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos2_Off"].children[0],null, displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos2_Off"].x-67);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos2_On"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos2_On"].x-67);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos3_Off"].children[0],null, displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos3_Off"].x-83);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos3_On"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos3_On"].x-83);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos4_Off"].children[0],null, displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos4_Off"].x-97);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos4_On"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos4_On"].x-97);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos5_Off"].children[0],null, displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos5_Off"].x-110);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos5_On"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos5_On"].x-110);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos6_Off"].children[0],null, displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos6_Off"].x-124);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos6_On"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos6_On"].x-124);

                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsAnimation4_On"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsAnimation4_On"].x-96);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsAnimation5_On"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsAnimation5_On"].x-108);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsAnimation6_On"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsAnimation6_On"].x-124);
                ...
                setPorytraitAssets_(displayManager_.getGroup("preview").bgPreview1.children[0],true,100,160);
                setPorytraitAssets_(displayManager_.getGroup("preview").bgPreview2.children[0],true,100, 650);
            ...
            //harp
            setPorytraitAssets_(displayManager_.getGroup("harp").he.children[0],null,185,378);
            ...
            for (var i =8;i<=13;i++){
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos" + i +"_Off"].children[0],null,displayManager.groups.freeSpinAccumulator.graphAsset["fsPos" + i +"_Off"].x,displayManager.groups.freeSpinAccumulator.graphAsset["fsPos" + i +"_Off"].y);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulator")["fsPos" + i +"_On"].children[0],null,displayManager.groups.freeSpinAccumulator.graphAsset["fsPos" + i +"_On"].x,displayManager.groups.freeSpinAccumulator.graphAsset["fsPos" + i +"_On"].y);
                //displayManager_.getGroup("freeSpinAccumulator")["anchor" + i +"_In"].children[0].scale.x=-1;
            }
            for (var i =1;i<=6;i++){
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos" + i +"_Off"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos" + i +"_Off"].x,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos" + i +"_Off"].y);
                setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos" + i +"_On"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos" + i +"_On"].x,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsPos" + i +"_On"].y);
                if(displayManager_.getGroup("freeSpinAccumulatorFs")["fsAnimation" + i +"_On"]!=undefined)setPorytraitAssets_(displayManager_.getGroup("freeSpinAccumulatorFs")["fsAnimation" + i +"_On"].children[0],null,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsAnimation" + i +"_On"].x,displayManager.groups.freeSpinAccumulatorFs.graphAsset["fsAnimation" + i +"_On"].y);
            }
            ...
            //top FS
            setPorytraitAssets_(displayManager_.getText("fsmultT"),true,1167,212);
            setPorytraitAssets_(displayManager_.getText("fsAdditionalT"),true,1167,167);
            setPorytraitAssets_(displayManager_.getText("fsAdditional"),true,1156,206);
            ...
            //bottom FS
            setPorytraitAssets_(displayManager_.getText("fsLabel"),true,1167,90);
            setPorytraitAssets_(displayManager_.getText("fsValue"),true,1167,105);
            setPorytraitAssets_(displayManager_.getText("fsMultValue"),true,1167,238);
            setPorytraitAssets_(displayManager_.getText("totWonLabel"),true,1167,330);
            setPorytraitAssets_(displayManager_.getText("totWonValue"),true,1167,345);
    ...
    function hideGame_(flag){
        ...
        if (freeSpinsManager_!=undefined) {
            ...
            if (getOrientation()!="portrait"){
                if (displayManager_.getGroup("harp").he.children[0].visible==true) {
                    displayManager_.getGroup("harp").visible = !flag;
                }else{
    ...
    function resume_(){
        ...
        if (communicationManager_.getResumeStatus().status.hand=="tumble" && communicationManager_.getResumeStatus().status.type=="normal") {
            ...
            if (sucessiveWin_>0) {//resume prev anchors on base game only
                for (var i=1;i<=sucessiveWin_;i++) {
                    if (i<=6) {
                        var anchor = displayManager_.getGroup("freeSpinAccumulatorFs")["fsPos" + i + "_On"].children[0];
                        anchor.visible = true;
                    }
                }
            }
        ...
        if (sucessiveWin_!= anchorPos_ ){
            if (freeSpinsManager_.getIsInFs()==true){
                ...
                if (sucessiveWin_>0){
                    for (var i = 1; i <= sucessiveWin_; i++) {
                        if (i<=6) {
                            var anchor = displayManager_.getGroup("freeSpinAccumulator" + fs)["fsPos" + i + "_On"].children[0];
                            anchor.visible = true;
                            anchor = displayManager_.getGroup("freeSpinAccumulator" + fs)["fsPos" + i + "_Off"].children[0];
                            anchor.visible = false;
                            if (i>3){
                                anchor = displayManager_.getGroup("freeSpinAccumulator" + fs)["fsAnimation" + i + "_On"].children[0];
                    ...
                    if (sucessiveWin_>3 && fs!="" && freeSpinsManager_.getIsInFs() && spinManager_.getSpinResp()!=undefined && spinManager_.getFsResp()!=undefined && spinManager_.getFsResp().won !=undefined && (spinManager_.getFsResp().won>1)){
...
return;
        ...
        if (isTumbling_==false && lineManager_.getInterruptedWinAnim()==false && harpID<0) {
            ...
            if (spinManager_.getSpinResp().status.harpBonusID>0 && spinManager_.getSpinResp().status.harpBonusID<=5){
                ...
                if (harpID==1){
                    ...
                    //respin 1
                    respin_=true;
                    eventManager_.addEvent(realDoSpin_, 2000);
    ...
    function harpEvent_(obj){
        ...
        //     displayManager_.getGroup("harp").visible=true;
        //     displayManager_.getGroup("harp").he.children[0].visible=true;
        //     displayManager_.getGroup("harp").he.children[0].animations.add("anim");
        //     displayManager_.getGroup("harp").he.children[0].animations.play("anim",24,false,false);
        //     setTimeout(harpPrize_,200,id,won,numTumbles);
        // }else{

        //if ((id ==1 && won>0)||(id ==2 && won>0)||(id ==3 && won>0)||(id ==3 && won==0 && numTumbles>5)||id>3) {

        if (framework.isTouch() && getOrientation()=="portrait"){
            soundManager_.playSound("harp"+id);
            displayManager_.getGroup("harp").visible=true;
            displayManager_.getGroup("harp").alpha=0;
            displayManager_.getText("harptext").visible=false;
            displayManager_.getText("harpHead").visible=false;
            ...
            displayManager_.getGroup("harp").he.children[0].animations.add("anim");
            displayManager_.getGroup("harp").he.children[0].animations.play("anim",24,false,false);
            displayManager_.getGroup("harp").bg.children[0].scale.x=1.2;
            displayManager_.getGroup("harp").bg.children[0].scale.y=1.2;

            setTimeout(harpPrizeMsgMobile_,0,[id,won,numTumbles]);
            setTimeout(harpPrize_,1500,[id,won,numTumbles]);
            setTimeout(hideHarpMobile_,1400);
        }else{
            soundManager_.playSound("harp"+id);
            displayManager_.getGroup("harp").visible=true;
            displayManager_.getText("harptext").visible=false;
            ...
            displayManager_.getGroup("harp").he.children[0].visible=true;
            displayManager_.getGroup("harp").he.children[0].animations.add("anim");
            displayManager_.getGroup("harp").he.children[0].animations.play("anim",30,false,false);
            displayManager_.getGroup("harp").bg.children[0].scale.x=.7;
            displayManager_.getGroup("harp").bg.children[0].scale.y=.5;
            displayManager_.getGroup("harp").alpha=1;

            if (id==1) {
                setTimeout(harpObjects_, 100, [id, won, numTumbles]);
                setTimeout(harpPrizeMsg_, 800, [id, won, numTumbles]);
                setTimeout(harpPrize_, 2200, [id, won, numTumbles]);
                setTimeout(hideHarp_, 2000);
            }else{
                setTimeout(harpObjects_, 100, [id, won, numTumbles]);
                setTimeout(harpPrizeMsg_,1000,[id,won,numTumbles]);
                setTimeout(harpPrize_,1500,[id,won,numTumbles]);
                setTimeout(hideHarp_,3000);
            }
        }
    }
    ...
    function harpObjects_(par){
        var id=par[0];
        if (id==1){//wild
            for (var i=0; i< harpValue;i++) {
                setTimeout(addWilds_, 200 * i,i);
            }
        }
        if (id==3 ){//stalk climb
            for (var i = 0; i < harpValue; i++) {
                setTimeout(addStalk_, 300 * i, i);
            }
        }
    }
   ...
   function harpPrizeMsgMobile_(par){
    ...
    function addWilds_(i){
        displayManager_.getGroup("scatter").visible=true;
        var lf = game_.add.sprite(displayManager_.getGroup("harp").he.children[0].x - 20 + (20 * i), displayManager_.getGroup("harp").he.children[0].y + 8, "wharp");
        lf.alpha = 1;
        lf.anchor.set(.5, .5);
        lf.scale.x =1.5;
        lf.scale.y = 1.5;
        displayManager_.getGroup("scatter").add(lf);

        TweenMax.to(lf, .8, {delay: .4, alpha: 0});
        TweenMax.to(lf, .8, {delay: .1, y: displayManager_.getGroup("harp").he.children[0].y - 100});
        //todo remove objs
    ...
    function addStalk_(int){
        displayManager_.getGroup("scatter").visible=true;
        var lf= game_.add.sprite(displayManager_.getGroup("harp").he.children[0].x-30 +(20*int),displayManager_.getGroup("harp").he.children[0].y+4 , "anchorIn_1" );
        lf.alpha=1;
        lf.anchor.set(.5,.5);
        lf.animations.add("anim");
        lf.animations.play("anim",54,false,true);
        lf.scale.x=.6;
        lf.scale.y=.6;
        displayManager_.getGroup("scatter").add(lf);

        TweenMax.to(lf, .8, {delay: .5, alpha: 0});
        TweenMax.to(lf, .8, {delay: .1, y: displayManager_.getGroup("harp").he.children[0].y - 100});
    }
    ...
    function fsLogoOut_(){
        ...
        for (var i = 1; i < 7; i++) {
            displayManager_.getGroup("freeSpinAccumulatorFs" )["fsPos" + i + "_Off"].children[0].visible=true;
        }
    ...
    function logoIn_(){
        ...
        displayManager_.getGroup("lockReels").visible = false;
        for (var i = 1; i < 7; i++) {
            displayManager_.getGroup("freeSpinAccumulatorFs" )["fsPos" + i + "_Off"].children[0].visible=false;
            displayManager_.getGroup("freeSpinAccumulatorFs" )["fsPos" + i + "_On"].children[0].visible=false;
        }
        var fs="";
        for (var i = 1; i <= 13; i++) {
            if (i<=8) {
    ...
    function doBuyFeature_() {
        ...
        obj.options[0].extra="";
        obj.options[0].price=40;
        obj.options[1]={};
        obj.options[1].rounds=8;
        obj.options[1].extra="";
        obj.options[1].price=70;
        obj.options[2]={};
        obj.options[2].rounds=9;
        obj.options[2].extra="";
        obj.options[2].price=90;
        obj.options[3]={};
        obj.options[3].rounds=10;
        obj.options[3].extra="x2";
        obj.options[3].price=110;
        obj.options[4]={};
        obj.options[4].rounds=11;
        obj.options[4].extra="x2";
        obj.options[4].price=150;
        obj.options[5]={};
        obj.options[5].rounds=12;
        obj.options[5].extra="x3";
        obj.options[5].price=200;
        obj.options[6]={};
        obj.options[6].rounds=12;
        obj.options[6].extra="x3";
        obj.options[6].price=240;
        ...
        if (canSpin_==true && spinning_==false && isTumbling_==false && (window.SPIN_STATE==undefined || window.SPIN_STATE.spinning!="true") ) {//todo ask Joe about mobile
            if (freeRoundsManager_.getIsInFr()==false && autoPlayManager_.getIsInAutoPlay()==false && lineManager_.getInterruptedWinAnim()==false ) {
                canSpin_=false;
                featureMessageReq_.showMultipleMessageMWJ("Buy Free Spins round", "Select from the list to get the price.","", buyFeatureCB_, noBF_, obj.options);
            }
        }
    }
    function noBF_(){
