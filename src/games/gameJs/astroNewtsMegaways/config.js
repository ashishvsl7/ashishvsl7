...
var loaderAssets={
    "assets": {
        "winWayOb": "astroNewtsMegaways/img/loader/btg-megaways.png"
    },
    "loaderMc": {
        "staticLoaderLogo": {
            "sprite": "astroNewtsMegaways/img/intro-logo.png",
            "w": 360,
            "h": 360
        },
        "ironDogLogo": {
...
var gameAssets = {
    "assets": {
        ...
        "bgPreviewAl":"astroNewtsMegaways/img/paytable/character-right.png",
    ...
    "animations": {
        "bg_fl_1":{
            "json": "astroNewtsMegaways/img/bg/background-animation/left-anim-bg-pt1.json",
            "sprite": "astroNewtsMegaways/img/bg/background-animation/left-anim-bg-pt1.png"
        } ,
        "bg_fr_1": {
            "json": "astroNewtsMegaways/img/bg/background-animation/right-anim-bg-pt1.json",
            "sprite": "astroNewtsMegaways/img/bg/background-animation/right-anim-bg-pt1.png"
        },
        "bg_frFS_1": {
            "json": "astroNewtsMegaways/img/bg/background-animation/right-anim-bg-pt1.json",
            "sprite": "astroNewtsMegaways/img/bg/background-animation/right-anim-bg-pt1.png"
        ...
        "bg_fl_2":{
            "json": "astroNewtsMegaways/img/bg/background-animation/left-anim-bg-pt2.json",
            "sprite": "astroNewtsMegaways/img/bg/background-animation/left-anim-bg-pt2.png"
        } ,
        "bg_fr_2": {
            "json": "astroNewtsMegaways/img/bg/background-animation/right-anim-bg-pt2.json",
            "sprite": "astroNewtsMegaways/img/bg/background-animation/right-anim-bg-pt2.png"
        },
        "bg_frFS_2": {
            "json": "astroNewtsMegaways/img/bg/background-animation/right-anim-bg-pt2.json",
            "sprite": "astroNewtsMegaways/img/bg/background-animation/right-anim-bg-pt2.png"
