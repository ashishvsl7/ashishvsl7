...
function Framework(forceMobile) {
    ...
    function delayedDoSetup_(setupJson){
        ...
        if(loginVars.getRegParams().jurisdiction !="dk" && loginVars.getRegParams().jurisdiction !="mt" && loginVars.getRegParams().jurisdiction !="se" && loginVars.getRegParams().jurisdiction !="uk" && loginVars.getRegParams().jurisdiction !="it" && loginVars.getRegParams().jurisdiction !="es" && loginVars.getRegParams().jurisdiction !="co" && loginVars.getRegParams().jurisdiction !="be") {
        ...
        if (uniqueBetValues && ReelConfig.newComm!=true) {
            ...
            communicationManager_.uniqueBetValuesRequest().done(function(data) {
                ...
                loaderManager_.hideLoader(initGameClasses_); //init All game classes
    ...
    function resize_(_x, _y, _s) {
        if (ReelConfig.newUI) {
            ...
            if (isTouch_()==true && ReelConfig.newUI==true) {
                ...
                $("#mainViewport").css("height", 720 + "px");
