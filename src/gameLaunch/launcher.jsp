...
String langCDN = "https://"+request.getServerName()+"/";

//if (request.getScheme().equals("http")){
  //path= "https://"+request.getServerName()+"/f1x2games/";
  //langCDN = "https://"+request.getServerName()+"/";
//}
...
String seeding = request.getParameter("seeding");
String singleTexts = request.getParameter("singleTexts");
String forceMobile = request.getParameter("forceMobile");//force mobile
String log = request.getParameter("log");
String confType = request.getParameter("confType");
String clientName = request.getParameter("clientName");

String keepAliveInterval = request.getParameter("keepAliveInterval");
String keepAliveURL = request.getParameter("keepAliveURL");
String balanceBeforeSpin = request.getParameter("balanceBeforeSpin");
if(balanceBeforeSpin==null)balanceBeforeSpin="false";
%>
...
if(Integer.parseInt(version)==2)folderName="cosmicCrystals";
if(Integer.parseInt(version)==3)folderName="paint";
if(Integer.parseInt(version)==4)folderName="cherryBlast";
if(Integer.parseInt(version)==5)folderName="giftOfOstara";
if(Integer.parseInt(version)==6)folderName="treasureOfHorus";
if(Integer.parseInt(version)==7)folderName="neonJungle";
if(Integer.parseInt(version)==8)folderName="bloodQueen";
if(Integer.parseInt(version)==9)folderName="rainbowGold";
if(Integer.parseInt(version)==10)folderName="sirensKingdom";
if(Integer.parseInt(version)==11)folderName="waiKiki";
if(Integer.parseInt(version)==12)folderName="siXiang";
