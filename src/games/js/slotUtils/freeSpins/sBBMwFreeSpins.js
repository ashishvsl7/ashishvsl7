/**
 * KiS Framework, Created by Fabry on 20/09/2021.
 * handles SBBMW free spins
 */
function SBBMwFreeSpins(gameRef,gameClass){
    var game_=gameRef;
    ...
    function parse_(json){
        ...
        /* //useless as the cap now is on the backend and it was screwin the resume
        var max=50000*10;
    ...
    function showFsTotWonPanel_(){
        ...
        freeSpinNum_=-999;
         if (isInFs_) {
            ...
            winManager_.updateWinAmt(winCash_);
            if (getOrientation() == "portrait") displayManager_.getText("lineWin").y = 360;
            lineManager_.showBonusWin(win_, winCash_);
