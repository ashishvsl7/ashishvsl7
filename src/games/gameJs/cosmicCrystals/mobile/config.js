...
var gameAssets = {
    "assets": {
        ...
        "buttonBg": "cosmicCrystals/img/cp-bg.png",
    ...
    "buttonsSpriteSheet": {
        ...
        "stopButton": {
            "sprite": "cosmicCrystals/img/cp-btn-stop.png",
            "json": "cosmicCrystals/img/cp-btn-stop.png",
            "w": 128,
            "h": 76
        },
        "yesButton": {
...
var ReelConfig = {
    ...
    "comment_type of lines": "shader/lineImg/rope/particle/curveDraw/lineDraw/noLines_HL",
...
var paytableAssets = {
    ...
    "helpPath" : gameParams.pathCDN + 'premiumslots/remoteHelp.jsp?rPage=help/mobile/cosmicCrystals/help_' + gameParams.lang,
        ...
        },
		{
			...
			"text" : [

				{
					...
					"xpos" : gameParams.lang == "ru" ? "140" : "180",
					"ypos" : gameParams.lang == "ru" ? "370" : "380",
					"width" : gameParams.lang == "ru" ? "675" : "600",
					"fill" : "#FF85EE",
					"font" : "FuturaPT-Book, Arial, sans-serif",
					"size" : "14px",
					"align" : "center"
