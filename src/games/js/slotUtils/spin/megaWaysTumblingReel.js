function  MegaWaysTumblingReel(gameRef,gameClass,_num,num2,swap,len){
    var game_=gameRef;
    ...
    function setIcon_(index,icon){
        ...
        if (numIcon_>5 && (characterList.indexOf(icon)<0 || gameParams.gameOriginalID=="7030")  ){
            var ratio=size_[numIcon_]/img[index].height+((icon==10)?(gameParams.gameOriginalID=="7019")?.07:.3:.1);
            if (gameParams.gameOriginalID=="7030"){
                if (icon ==5 ||icon ==6 ||icon ==7 ){
                    if (numIcon_==5){
                        ratio=size_[numIcon_]/img[index].height-.13;
                    }else if (numIcon_==6){
                        ratio=size_[numIcon_]/img[index].height+0;
                    }else if (numIcon_==7){
                        ratio=size_[numIcon_]/img[index].height+0;
                    }
                }else if (icon ==9){
                    if (numIcon_==6){
                        ratio=size_[numIcon_]/img[index].height+0.35;
                    }else if (numIcon_==7){
                        ratio=size_[numIcon_]/img[index].height+0.45;
                    }                    
                }else if (icon ==10 || icon ==12){
                    if (numIcon_==5){
                        ratio=size_[numIcon_]/img[index].height-0.03;
                    }else if (numIcon_==6){
                        ratio=size_[numIcon_]/img[index].height-0.02;
                    }else if (numIcon_==7){
                        ratio=size_[numIcon_]/img[index].height-0.01;
                    }                    
                }            
            }
    ...
    function swapSmb_  (icon,dest_,attr_){
        ...
        if (numIcon_>=5 && (characterList.indexOf(icon)<0 || gameParams.gameOriginalID=="7030") ){
            ...
            if (gameParams.gameOriginalID=="7030"){
                if (icon ==5 ||icon ==6 ||icon ==7 ){
                    if (numIcon_==5){
                        ratio=size_[numIcon_]/img[dest].height-.13;
                    }else if (numIcon_==6){
                        ratio=size_[numIcon_]/img[dest].height+0;
                    }else if (numIcon_==7){
                        ratio=size_[numIcon_]/img[dest].height+0;
                    }
                }else if (icon ==9){
                    if (numIcon_==6){
                        ratio=size_[numIcon_]/img[dest].height+0.35;
                    }else if (numIcon_==7){
                        ratio=size_[numIcon_]/img[dest].height+0.45;
                    }                    
                }else if (icon ==10 || icon ==12){
                    if (numIcon_==5){
                        ratio=size_[numIcon_]/img[dest].height-0.03;
                    }else if (numIcon_==6){
                        ratio=size_[numIcon_]/img[dest].height-0.02;
                    }else if (numIcon_==7){
                        ratio=size_[numIcon_]/img[dest].height-0.01;
                    }                    
                }            
            }
    ...
    function iconAdjustment_(image,icon,frame){
        ...
        if (isBrandedMw()) {
            if (gameParams.gameOriginalID!=7030){
                if (numIcon_>4 && (characterList.indexOf(icon)>=0)){
                    var offset=2.5*(numIcon_)
            ...
            if (gameParams.gameOriginalID!=7025){
                ...
                //rainbow wilds MW has its needs
                //if (icon==11 || icon==12)return; //regular wild, no need to mask
                if (numIcon_==7) {
                    if (icon==9){
