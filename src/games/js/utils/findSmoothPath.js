        ...
        if (percent >= 1) {
            ...
            if (drawCurrentItem < nodeArray_.length - 1) {
                ...
                if (thirdItem == null) {
                    ...
                    var node1 = new Phaser.Point(firstItem.x - x0speed, firstItem.y - y0speed);
                    var node2 = new Phaser.Point(secondItem.x + xspeed, secondItem.y + yspeed);
                }
            } else {
                stopRender = true;
            }
        } else {
            var _point = new Phaser.Point()
