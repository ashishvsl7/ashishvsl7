 ...
 */
function PixiMillionWayTumblingWinnings(gameRef, gameClass) {
    ...
    function delayedAnimation_(smb,a){
        ...
        smb.simbolReference[a].visible = false;
        smb.anim[a] = spriteManager_.addSpine(smb.pos[a].x + ReelConfig.icon.width / 2,  smb.pos[a].y +  size_[getReelState_(smb.reel[a])][spinManager_.getSpinReelResp().reel[smb.reel[a]].smb.length] / 2, "anim" + ic,null,null,.25);
        ...
        smb.anim[a].play("win_"+ getReelState_(smb.reel[a])+ "_0"+ spinManager_.getSpinReelResp().reel[smb.reel[a]].smb.length,false);
